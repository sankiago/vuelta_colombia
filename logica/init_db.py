...
def crear_tablas(conexion):
  ...
  sentencia_clasificacion = 'CREATE TABLE    clasificacion(num_etapa INTEGER                                         , num_ciclista INTEGER       , num_etapa_num_ciclista TEXT PRIMARY KEY, posicion_etapa TEXT, tiempo_empleado INTEGER, num_equipo INTEGER, esta_retirado BOOLEAN, FOREIGN KEY(num_equipo) REFERENCES equipos(num_equipo), FOREIGN KEY(num_ciclista) REFERENCES ciclistas(num_inscripcion_ciclista))'     
